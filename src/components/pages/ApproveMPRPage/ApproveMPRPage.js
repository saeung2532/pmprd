...
export default (props) => {
  ...
  useEffect(() => {
    ...
    let fromStatus = "15";
    let toStatus = "20";
    dispatch(finalapproveActions.getMPRApproveFinal(fromStatus, toStatus));
        ...
        actions={[
          (rowData) => ({
            ...
            onClick: (event, rowData) => {
              ...
              let toStatus = "20";
              props.history.push(
                `/approvempr/approve/${loginActions.getTokenCono()}/${loginActions.getTokenDivi()}/${
                  rowData.HD_IBPLPN
